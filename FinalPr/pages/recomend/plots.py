...
def plot_malla(df_Beer):
    fig = px.scatter_3d(df_Beer, x='review/taste', y='review/aroma', z='beer/ABV',
                        title='3D Scatter plot of Taste, Aroma and ABV')
    st.plotly_chart(fig)
...
def plot_beer_wordcloud(df_Beer):
    ...
    beer_mask = np.array(Image.open('FinalPr/pages/recomend/images/beer.png'))
